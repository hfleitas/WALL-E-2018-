...
namespace Microsoft.Bot.Sample.QnABot
{
    ...
    public class BasicQnAMakerPreviewDialog : QnAMakerDialog
    {
        ...
        public BasicQnAMakerPreviewDialog() : base(new QnAMakerService(new QnAMakerAttribute(RootDialog.AppSettings("QnAAuthKey"), ConfigurationManager.AppSettings["QnAKnowledgebaseId"], "I'm not sure, please contact eve@axiom.com.", 0.5)))
        { }
    }
    ...
    public class BasicQnAMakerDialog : QnAMakerDialog
    {
        ...
        // Optional: defaultMessage, scoreThreshold[Range 0.0 – 1.0]
        public BasicQnAMakerDialog() : base(new QnAMakerService(new QnAMakerAttribute(RootDialog.AppSettings("QnAAuthKey"), ConfigurationManager.AppSettings["QnAKnowledgebaseId"], "I'm not sure, please contact eve@axiom.com.", 0.5, 1, ConfigurationManager.AppSettings["QnAEndpointHostName"])))
        { }
